...
if __name__=="__main__":
    ...
    ont_hash = oboEn.getHPOHashTable(obo)
    ontMeth.processRawHPOFile(annoFile,geneONT)
    ontMeth.getFile_HPO(ont_hash, geneONT, geneONTPar,geneNoONT,"T")
