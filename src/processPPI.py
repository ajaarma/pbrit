...
def usage(err=[]):
    ...
    if err:
        print "\n\n"
        print err
        print "python processPPI.py -a <analysis-xml-file> -t PPI\n\n"
    else:
...
if __name__=="__main__":
    ...
    ontMeth.processRawPPFile(annoFile,genePP,matRow,matCol,matSpr)
